...
export const publicPagesEn = {
  ...
  directoryFilters: {
    ...
    region: 'Region',
    regionHint: 'A province or state within a country. Choose a country first to narrow this list.',
    noRegions: 'No published profile has listed a region yet.',
    country: 'Country',
...
export const publicPagesEs: PublicPagesDict = {
  ...
  directoryFilters: {
    ...
    region: 'Región',
    regionHint: 'Una provincia o estado dentro de un país. Elija antes un país para acotar la lista.',
    noRegions: 'Ningún perfil publicado ha indicado todavía una región.',
    country: 'País',
